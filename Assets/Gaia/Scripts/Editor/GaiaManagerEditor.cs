...
namespace Gaia
{
    ...
    public class GaiaManagerEditor : EditorWindow
    {
        ...
        {
            Application.OpenURL(
                "https://forum.unity3d.com/threads/gaia-aaa-terrain-generator-procedural-texturing-planting-and-scene-creation.327342/");
        }
        ...
        {
            Application.OpenURL("http://www.procedural-worlds.com/gaia/tutorials/");
        }
        ...
        {
            Application.OpenURL("http://www.procedural-worlds.com/gaia/gaia-extensions/");
        }

        /// <summary>
        /// Show documentation
        /// </summary>
        [MenuItem("Window/Gaia/Show CTS Terrain Shader...", false, 62)]
        ...
        void DrawExtensionsEditor()
        {
            ...
            {
                EditorGUI.indentLevel++;
                if (GUILayout.Button("Show Extensions"))
                {
                    Application.OpenURL("http://www.procedural-worlds.com/gaia/gaia-extensions/");
                }
                EditorGUI.indentLevel--;
